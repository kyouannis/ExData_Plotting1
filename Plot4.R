...
plot(epc2$datetime, epc2$Voltage, type = "l", ylab = "Global Active Power (kilowatts)", xlab = "datetime")
...
plot(epc2$datetime, epc2$Global_reactive_power, type = "l", ylab = "Global_reactive_power", xlab = "datetime")
